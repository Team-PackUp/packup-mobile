...
class BannerSection extends StatelessWidget {
  ...
  const BannerSection({super.key, required this.regionCode});
  ...
  Widget build(BuildContext context) {
    ...
    final banner = banners.firstWhere(
          (b) => b.regionCode == regionCode,
      orElse: () => banners.firstWhere((b) => b.regionCode == '11'),
    );
    ...
    return Padding(
      ...
      child: HomeBanner(
        ...
        onTap: () {
          context.push('/banner/${banner.regionCode}');
        },
      ),
    );
  }
